...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('major_category_translations', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->unique(['major_category_id', 'locale']);
    ...
    {
        Schema::dropIfExists('major_category_translations');
    }
};
