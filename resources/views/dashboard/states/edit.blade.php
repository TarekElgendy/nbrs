    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('dashboard.states.index') }}"> @lang('site.section')</a></li>
                                ...
                                <div class="box-body ">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label>@lang('dash.cities') </label>
                                            <select name="city_id" required="required" class="form-control">
                                                <option value="">@lang('dash.select') @lang('dash.cities')</option>
                                                @foreach ($cities as $item)
                                                    <option value="{{ $item->id }}" {{ $state->city_id==$item->id?'selected':'' }}>{{ $item->title }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        @foreach (config('translatable.locales') as $key => $locale)
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="{{ $locale }}[title]" class="form-control"
                                                    value="{{ $state->translate($locale)->title }}">
                                            </div>
                            ...
                            <div class="box box-danger hidden">
                                ...
                                <div class="box-body ">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <img src="{{ $state->icon_path }}" style="width: 100px"
