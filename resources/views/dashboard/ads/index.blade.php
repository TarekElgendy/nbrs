    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">@lang('dash.ads')</li>
            </ol>
        </section>
        <section class="content">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title" style="margin-bottom: 15px">@lang('dash.ads')
                        <small>
                    ...
                    <form action="{{ route('dashboard.ads.index') }}" method="get">
                        <div class="row">
                            <div class="{{ $ad_search == 'close' ? 'hidden' : '' }}">
                                <div class="col-md-4">
                            ...
                            <div class="col-md-4 {{ $ad_add == 'close' ? 'hidden' : '' }}">
                                        ...
                                        <td>
                                            @if (auth()->user()->hasPermission('ads-update'))
                                                <a href="{{ route('dashboard.ads.edit', $ad->id) }}"
                                                    class="btn btn-info btn-sm {{ $ad_edit == 'close' ? 'hidden' : '' }}"><i
                                            ...
                                            @if (auth()->user()->hasPermission('ads-delete'))
                                                <form action="{{ route('dashboard.ads.destroy', $ad->id) }}"
                                                    ...
                                                    {{ method_field('delete') }}
                                                    <button type="submit"
                                                        class="btn btn-danger delete btn-sm {{ $ad_delete == 'close' ? 'hidden' : '' }}"><i
