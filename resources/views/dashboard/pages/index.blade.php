...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">@lang('dash.pages')</li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title" style="margin-bottom: 15px">@lang('dash.pages')
                    <small>
                        ...
                        <div class="{{ $section_search == 'close' ? 'hidden' : '' }}">
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="type" required="required" class="form-control">
                                    ...
                                    <option value="{{ $item }}" {{ $item==request()->type ? 'selected' : '' }}>{{ $item
                                        }}
                                    </option>
                                    @endforeach
                                </select>
                ...
                <table class="table table-hover" id="data_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="{{ $item->image_path }}" style="width: 100px;" class="img-thumbnail" alt="">
                            </td>
                            <td>
                                <a href="{{ route('dashboard.pages.duplicate', $item->id) }}"
                                ...
                                <a href="{{ route('dashboard.pages.edit', $item->id) }}"
                                ...
                                <form action="{{ route('dashboard.pages.destroy', $item->id) }}" method="post"
