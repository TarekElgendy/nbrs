                         ...
                         <div class="row">
                            <div class="col-md-4">
                                 @if (auth()->user()->hasPermission('admins-create'))
                                    <a href="{{ route('dashboard.permissions.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('site.add')</a>
                                @else
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (auth()->user()->hasPermission('admins-update'))
                                            <a href="{{ route('dashboard.permissions.edit', $permission->id) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> @lang('site.edit')</a>
                                        @else
