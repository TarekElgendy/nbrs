    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('dashboard.categories.index') }}"> @lang('site.section')</a></li>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="section_id" required="required" class="form-control">
                                                ...
                                                @foreach ($sections as $item)
                                                    <option value="{{ $item->id }}" {{ $category->section_id==$item->id?'selected':'' }}>{{ $item->title }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        @foreach (config('translatable.locales') as $key => $locale)
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="{{ $locale }}[short_description]" id="" class="form-control" cols="30"
                                                    rows="5">{{ $category->translate($locale)->short_description }}</textarea>
                                            </div>
                                            <div class="form-group">
                            ...
                            <div class="box box-danger ">
                                ...
                                <div class="box-body ">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <img src="{{ $category->icon_path }}" style="width: 100px"
                                        ...
                                        @foreach (config('translatable.locales') as $key => $locale)
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="{{ $locale }}[seo_key]"
                                                    class="form-control tag" value="{{ $category->translate($locale)->seo_key  }}">
                                            </div>
                                            <div class="form-group">
                                                <label>@lang('site.' . $locale . '.seo_des')</label>
                                                <textarea name="{{ $locale }}[seo_des]" id="" class="form-control" cols="30" rows="5">{{ $category->translate($locale)->seo_des   }}</textarea>
                                            </div>
                                            <div class="  with-border"></div><br>
                                        @endforeach
                                    </div>
