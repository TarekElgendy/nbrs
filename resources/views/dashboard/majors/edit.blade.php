    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('dashboard.majors.index') }}"> @lang('site.section')</a></li>
        ...
        <section class="content">
            ...
            --}}
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.majors.update', $major->id) }}" method="post"
                                            ...
                                            <select name="major_category_id" required="required" class="form-control">
                                                ...
                                                @foreach ($majorCategories as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ $major->major_category_id == $item->id ? 'selected' : '' }}>
                                                        {{ $item->title }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        @foreach (config('translatable.locales') as $key => $locale)
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="{{ $locale }}[title]"
                                                    class="form-control" value="{{ $major->translate($locale)->title }}">
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
