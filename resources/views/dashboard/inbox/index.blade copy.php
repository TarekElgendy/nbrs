                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <option value="">الحالة</option>
                                    <option value="inactive" {{ request()->status=="inactive" ? 'selected' :'' }}>لم يتم التواصل معه	   </option>
            ...
            <div class="box-body">
                ...
                <div class="box-body table-responsive no-padding">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tr style="background-color:{{ $inbox->status=="inactive" ? '#f1d4d4' :'#04fb0938' }}">
                            ...
                            <td>
                                ...
                                <a href="{{ route('dashboard.inboxs.edit', $inbox->id) }}" class="btn btn-info  btn-sm"><i
                                        class="fa fa-edit"></i>
                                ...
                                <form action="{{ route('dashboard.inboxs.destroy', $inbox->id) }}" method="post" style="display: inline-block">
                                    {{ csrf_field() }}
                                    {{ method_field('delete') }}
