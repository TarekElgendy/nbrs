    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('dashboard.productitems.index') }}"> @lang('dash.productitems')</a></li>
        ...
        <section class="content">
            <div class="">
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.productitems.store') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('post') }}
                        <div class="col-md-4">
                            <!-- /one -->
