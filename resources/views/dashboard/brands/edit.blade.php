    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('dashboard.brands.index') }}"> @lang('site.section')</a></li>
                            ...
                            <div class="box box-danger ">
                                ...
                                <div class="box-body ">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <img src="{{ $brand->icon_path }}" style="width: 100px"
