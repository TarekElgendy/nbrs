                        ...
                        <table class="table table-hover " id="data_table">
                            ...
                            <tbody>
                                ...
                                <tr style="background-color:{{ $ticket->status=="pending" ? '#f1d4d4' :'#04fb0938' }}">
                                    ...
                                    <td>
                                        <strong>  {{$setting->seo_title}} </strong> : {{substr( $ticket->reply  ,0,225)}} ...<br>

                                        <strong>
                                            {{authCustomer()->full_name}} </strong> :  {{ $ticket->message==null?__('site.Noreply'):substr( $ticket->message  ,0,225)  }}
                                    ...
                                    <td>
                                        {{ __('site.'.$ticket->status) }}
                                    </td>
                                    <td>

                                    <a href="{{route('customer.profile.tickets.chat' ,[$ticket->id])}}"> @lang('site.details')</a>
