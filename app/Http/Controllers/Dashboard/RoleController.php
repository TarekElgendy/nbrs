...
class RoleController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware('permission:roles-create')->only(['index']);
        $this->middleware('permission:roles-update')->only(['index']);
        $this->middleware('permission:roles-delete')->only(['index']);
    } // end of __construct
