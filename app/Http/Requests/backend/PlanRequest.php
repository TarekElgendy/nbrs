...
class PlanRequest extends FormRequest
{
    ...
    public function createRules()
    {
        ...
        // $this->rules += ['image' => 'required|mimes:jpg,bmp,jpeg,gif,png,eps,raw,cr2,nef,orf,sr2,tif,tiff,|max:2048,' . $this->id];
        return $this->rules;
    }
    public function updateRules()
    {
        ...
        //   $this->rules += ['image' => 'nullable|mimes:jpg,bmp,jpeg,gif,png,eps,raw,cr2,nef,orf,sr2,tif,tiff,|max:2048,' . $item->id];
        return $this->rules;
    }
